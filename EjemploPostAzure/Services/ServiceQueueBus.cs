...
namespace EjemploPostAzure.Services
{
    public class ServiceQueueBus
    {
        ...
        {
            ServiceBusSender sender = this.client.CreateSender("colatarea");
        ...
        {
            ServiceBusProcessor processor = this.client.CreateProcessor("colatarea");
